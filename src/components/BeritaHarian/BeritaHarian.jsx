...
const BeritaHarian = () => {
  ...
  // Data contoh berita (ganti dengan data real)
  const berita = [
    {
      id: 1,
      image: '/assets/Berita_1.jpg',
      title: 'Salut, Ibu ini menemukan kekuatannya setelah baca Kitab Suci',
      content: 'Siolais, 30/9/2024 — Bulan Kitab Suci Nasional (BKSN) 2024 segera berakhir. ' +
      'Tetapi kemeriahan dan antusias umat belum berakhir. Beberapa paroki....',
      author: 'by KomsosKAK',
      date: '24 Des 2024'
    },
    {
      ...
      content: 'Kupang, 27/9/2024 — Meski hanya dihadiri oleh 8 peserta, KUB Bunda Segala Bangsa Paroki' + 
      'Penfui tetap melaksanakan kegiatan belajar kitab suci khususnya Injil (20/9)....',
      author: 'by KomsosKAK',
      date: '24 Des 2024'
    },
    {
      ...
      content: 'Di akhir pekan ketiga, dalam perjalanan menuju Kuasi Paroki Siolais, saya berkesempatan' 
      + ' mampir di satu kapela yang masih dalam wilayah kuasi Siolais, kapela St. Yohanes Pemandi Nifununa....',
      author: 'by KomsosKAK',
      date: '24 Des 2024'
    },
    {
          ...
          {visibleCards.map((item) => (
            <div key={item.id} className="berita-card">
              ...
              <div className="card-content-berita">
                ...
                <button className="read-more-berita">
